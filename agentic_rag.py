...
def grade_documents(state):
    ...
    #########The first statement was commented and the next were added to remove internet search in case no documents are found in the PDF guides.
    # web_search_needed = "Yes" if not filtered_docs else "No"
    web_search_needed = "No"
    if not filtered_docs:
        filtered_docs = "No information found"
    ####################################################################
